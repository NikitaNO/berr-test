...
import Header from '../components/do-it-test/Header.js';
import Footer from '../components/do-it-test/Footer';
import SiderMenu from '../components/do-it-test/SiderMenu';
