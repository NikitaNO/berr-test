    ...
    const routes = [
        {
            ...
            getIndexRoute(nextState, cb) {
                require.ensure([], require => {
                    cb(null, {component: require('./routes/do-it-test/Content/MyOrdersContent')})
                })
            },
            childRoutes: [
              {
                path: 'do-it-test/my-orders',
                name: 'do-it-test/my-orders',
                getComponent(nextState, cb) {
                  require.ensure([], require => {
                    cb(null, require('./routes/do-it-test/Content/MyOrdersContent'))
                  })
                }
              }, {
                path: 'do-it-test/dashboard',
                name: 'do-it-test/dashboard',
                getComponent(nextState, cb) {
                  require.ensure([], require => {
                    cb(null, require('./routes/do-it-test/Content/DashboardContent'))
                  })
                }
              }, {
                path: 'do-it-test/completed-orders',
                name: 'do-it-test/completed-orders',
                getComponent(nextState, cb) {
                  require.ensure([], require => {
                    cb(null, require('./routes/do-it-test/Content/CompletedOrdersContent'))
                  })
                }
              }, {
                path: 'do-it-test/my-order-templates',
                name: 'do-it-test/my-order-templates',
                getComponent(nextState, cb) {
                  require.ensure([], require => {
                    cb(null, require('./routes/do-it-test/Content/MyOrderTemplatesContent'))
                  })
                }
              }, {
